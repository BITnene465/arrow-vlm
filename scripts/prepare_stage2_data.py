...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stage2-aug-ratio", type=float, default=0.0, help="Fraction of train instances that receive one additional noisy stage2 sample.")
    parser.add_argument("--bbox-center-jitter-ratio", type=float, default=0.03, help="Relative bbox center jitter range, applied in original pixel space.")
    parser.add_argument("--bbox-scale-jitter-ratio", type=float, default=0.05, help="Relative bbox width/height jitter range, applied in original pixel space.")
...
def main() -> None:
    ...
    report = prepare_stage2_data(
        ...
        stage2_aug_ratio=args.stage2_aug_ratio,
